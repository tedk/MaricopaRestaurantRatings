...
public class Version {
    ...
    private static volatile DateFormat InstallDateFormat = new SimpleDateFormat("yyyyMMdd", Locale.US);
	...
	try {
	    ...
	    throw new IllegalStateException("Couldn't get own package information");
	}
